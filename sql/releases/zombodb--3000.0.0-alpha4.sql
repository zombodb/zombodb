...
SELECT '3000.0.0-alpha4 (ed3488803a763bac73160a63402c3935072ebc18)'
$$;
...
-- ./src/lib.rs:63:0
CREATE OR REPLACE FUNCTION zdb."ctid"("as_u64" bigint) RETURNS tid IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'ctid_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."to_queries_dsl"("queries" ZDBQuery[]) RETURNS json[] STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'to_queries_dsl_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_text"("input" text) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_text_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_jsonb"("input" JsonB) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_jsonb_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."zdbquery_to_jsonb"("input" ZDBQuery) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_to_jsonb_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."point_to_json"("point" point) RETURNS json PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'point_to_json_wrapper';
-- ./src/query_dsl/geo.rs:29:0
CREATE OR REPLACE FUNCTION zdb."point_array_to_json"("points" point[]) RETURNS json STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'point_array_to_json_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."geo_polygon"("field" text, "points" VARIADIC point[]) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'geo_polygon_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."anyelement_cmpfunc"("element" anyelement, "query" ZDBQuery) RETURNS bool PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'anyelement_cmpfunc_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC text[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_str_wrapper';
-- ./src/query_dsl/terms.rs:22:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC bool[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_bool_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC integer[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i32_wrapper';
-- ./src/query_dsl/terms.rs:46:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC bigint[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i64_wrapper';
-- ./src/query_dsl/terms.rs:54:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC real[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_f32_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."prefix"("field" text, "value" text) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'prefix_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."field_missing"("field" text) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'field_missing_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match_all"("boost" real DEFAULT '1.0') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'match_all_wrapper';
-- ./src/query_dsl/match_all.rs:28:4
CREATE OR REPLACE FUNCTION dsl."match_none"() RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'match_none_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."limit"("limit" bigint, "query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'limit_wrapper';
-- ./src/query_dsl/limit.rs:13:4
CREATE OR REPLACE FUNCTION dsl."offset"("offset" bigint, "query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'offset_wrapper';
-- ./src/query_dsl/limit.rs:21:4
CREATE OR REPLACE FUNCTION dsl."offset_limit"("offset" bigint, "limit" bigint, "query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'offset_limit_wrapper';
-- ./src/query_dsl/limit.rs:27:4
CREATE OR REPLACE FUNCTION dsl."min_score"("min_score" double precision, "query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'min_score_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."sort_many"("zdbquery" ZDBQuery, "sort_descriptors" VARIADIC SortDescriptor[]) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'sort_many_wrapper';
-- ./src/query_dsl/sort.rs:70:4
CREATE OR REPLACE FUNCTION dsl."sort_direct"("sort_json" json, "zdbquery" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'sort_direct_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."fuzzy"("field" text, "value" text, "boost" real DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "prefix_length" bigint DEFAULT NULL, "max_expansions" bigint DEFAULT '50', "transpositions" bool DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'fuzzy_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_containing"("little" ZDBQuery, "big" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_containing_wrapper';
-- ./src/query_dsl/span.rs:24:4
CREATE OR REPLACE FUNCTION dsl."span_first"("query" ZDBQuery, "end" bigint) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_first_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_multi"("query" ZDBQuery) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_multi_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_not"("include" ZDBQuery, "exclude" ZDBQuery, "pre_integer" bigint DEFAULT NULL, "post_integer" bigint DEFAULT NULL, "dis_integer" bigint DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_not_wrapper';
-- ./src/query_dsl/span.rs:117:4
CREATE OR REPLACE FUNCTION dsl."span_or"("clauses" VARIADIC ZDBQuery[]) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_or_wrapper';
-- ./src/query_dsl/span.rs:143:4
CREATE OR REPLACE FUNCTION dsl."span_term"("field" text, "value" text, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_term_wrapper';
-- ./src/query_dsl/span.rs:160:4
CREATE OR REPLACE FUNCTION dsl."span_within"("little" ZDBQuery, "big" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_within_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."wildcard"("field" text, "value" text, "boost" real DEFAULT '1.0') RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'wildcard_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."constant_score"("boost" real, "query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'constant_score_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."bool"("parts" VARIADIC BoolQueryPart[]) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'bool_wrapper';
-- ./src/query_dsl/bool.rs:43:4
CREATE OR REPLACE FUNCTION dsl."should"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'should_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."must_not"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'must_not_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."binary_and"("a" ZDBQuery, "b" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'binary_and_wrapper';
-- ./src/query_dsl/bool.rs:133:4
CREATE OR REPLACE FUNCTION dsl."and"("queries" VARIADIC ZDBQuery[]) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'and_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."not"("queries" VARIADIC ZDBQuery[]) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'not_wrapper';
-- ./src/query_dsl/bool.rs:190:4
CREATE OR REPLACE FUNCTION dsl."noteq"("query" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'noteq_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match"("field" text, "query" text, "boost" real DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" integer DEFAULT NULL, "lenient" bool DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "fuzzy_rewrite" text DEFAULT NULL, "fuzzy_transpositions" bool DEFAULT NULL, "prefix_length" integer DEFAULT NULL, "cutoff_frequency" real DEFAULT NULL, "auto_generate_synonyms_phrase_query" bool DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL, "operator" Operator DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'match_wrapper_wrapper';
-- ./src/query_dsl/matches.rs:171:4
CREATE OR REPLACE FUNCTION dsl."multi_match"("fields" text[], "query" text, "boost" real DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" integer DEFAULT NULL, "lenient" bool DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "fuzzy_rewrite" text DEFAULT NULL, "fuzzy_transpositions" bool DEFAULT NULL, "prefix_length" integer DEFAULT NULL, "cutoff_frequency" real DEFAULT NULL, "auto_generate_synonyms_phrase_query" bool DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL, "operator" Operator DEFAULT NULL, "match_type" MatchType DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'multi_match_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."datetime_range"("field" text, "lt" time with time zone DEFAULT NULL, "gt" time with time zone DEFAULT NULL, "lte" time with time zone DEFAULT NULL, "gte" time with time zone DEFAULT NULL, "boost" real DEFAULT NULL, "relation" Relation DEFAULT 'intersects') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'datetime_range_time_with_timezone_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."terms"("index" regclass, "field_name" text, "query" ZDBQuery, "size_limit" integer DEFAULT '2147483647', "order_by" TermsOrderBy DEFAULT NULL) RETURNS TABLE ("term" text, "doc_count" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_wrapper';
-- ./src/elasticsearch/aggregates/terms.rs:52:0
CREATE OR REPLACE FUNCTION zdb."tally"("index" regclass, "field_name" text, "stem" text, "query" ZDBQuery, "size_limit" integer DEFAULT '2147483647', "order_by" TermsOrderBy DEFAULT NULL, "shard_size" integer DEFAULT '2147483647', "count_nulls" bool DEFAULT 'true') RETURNS TABLE ("term" text, "count" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'tally_not_nested_wrapper';
...
-- ./src/elasticsearch/aggregates/terms.rs:335:0
...
CREATE OR REPLACE FUNCTION zdb."histogram"("index" regclass, "field" text, "query" ZDBQuery, "interval" double precision, "min_doc_count" integer DEFAULT '0') RETURNS TABLE ("term" numeric, "doc_count" bigint) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'histogram_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."arbitrary_agg"("index" regclass, "query" ZDBQuery, "json" JsonB) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'arbitrary_agg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."determine_index"("relation" regclass) RETURNS regclass VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'determine_index_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."index_name"("index_relation" regclass) RETURNS text VOLATILE STRICT PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'index_name_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."index_url"("index_relation" regclass) RETURNS text PARALLEL SAFE STRICT VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'index_url_wrapper';
-- ./src/access_method/options.rs:464:0
CREATE OR REPLACE FUNCTION zdb."index_type_name"("index_relation" regclass) RETURNS text PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_type_name_wrapper';
-- ./src/access_method/options.rs:471:0
CREATE OR REPLACE FUNCTION zdb."index_mapping"("index_relation" regclass) RETURNS JsonB PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_mapping_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."field_mapping"("index_relation" regclass, "field" text) RETURNS JsonB VOLATILE STRICT PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'field_mapping_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."raw_count"("index" regclass, "query" ZDBQuery) RETURNS bigint IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'raw_count_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."filters"("index" regclass, "labels" text[], "filters" ZDBQuery[]) RETURNS TABLE ("term" text, "doc_count" bigint) PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'filters_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."matrix_stats"("index" regclass, "fields" text[], "query" ZDBQuery) RETURNS TABLE ("term" text, "count" bigint, "mean" numeric, "variance" numeric, "skewness" numeric, "kurtosis" numeric, "covariance" json, "correlation" json) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'matrix_stats_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."cardinality"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'cardinality_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:94:0
CREATE OR REPLACE FUNCTION zdb."max"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'max_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."missing"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'missing_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:181:0
CREATE OR REPLACE FUNCTION zdb."value_count"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'value_count_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."range"("index" regclass, "field" text, "query" ZDBQuery, "range_array" json) RETURNS TABLE ("key" text, "from" numeric, "to" numeric, "doc_count" bigint) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'range_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."date_range"("index" regclass, "field" text, "query" ZDBQuery, "date_range_array" json) RETURNS TABLE ("key" text, "from" numeric, "from_as_string" text, "to" numeric, "to_as_string" text, "doc_count" bigint) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'date_range_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" tid, "score" double precision, "source" json) PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits_with_id"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" text, "score" double precision, "source" json) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_with_id_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."ip_range"("index" regclass, "field" text, "query" ZDBQuery, "range_array" json) RETURNS TABLE ("key" text, "from" inet, "to" inet, "doc_count" bigint) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'ip_range_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."query"("index" regclass, "query" ZDBQuery) RETURNS SETOF tid STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'query_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."analyze_text"("index" regclass, "analyzer" text, "text" text) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_text_wrapper';
-- ./src/elasticsearch/analyze.rs:137:0
CREATE OR REPLACE FUNCTION zdb."analyze_with_field"("index" regclass, "field" text, "text" text) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_with_field_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."score"("ctid" tid) RETURNS double precision PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'score_wrapper';
-- ./src/scoring/mod.rs:30:0
CREATE OR REPLACE FUNCTION zdb."want_scores"("query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'want_scores_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."want_highlight"("query" ZDBQuery, "field" text, "highlight_definition" json DEFAULT zdb . highlight ()) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'want_highlight_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."dump_query"("index" regclass, "query" ZDBQuery) RETURNS text STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'dump_query_wrapper';
-- ./src/zql/dsl/mod.rs:21:0
CREATE OR REPLACE FUNCTION zdb."debug_query"("index" regclass, "query" text) RETURNS TABLE ("normalized_query" text, "used_fields" text[], "ast" text) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'debug_query_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."suggest_terms"("index" regclass, "field_name" text, "suggest" text, "query" ZDBQuery) RETURNS TABLE ("term" text, "offset" bigint, "length" bigint, "suggestion" text, "score" double precision, "frequency" bigint) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'suggest_terms_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:51:0
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:67:0
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_missing_int_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."min_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'min_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:163:0
CREATE OR REPLACE FUNCTION zdb."min_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'min_agg_missing_float_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."max_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'max_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:228:0
CREATE OR REPLACE FUNCTION zdb."stats_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'stats_agg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."stats_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'stats_agg_missing_float_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:339:0
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:355:0
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_missing_float_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."matrix_stats_agg"("aggregate_name" text, "field" text[], "missing_field" text, "missing_value" bigint) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'matrix_stats_agg_missing_i64_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:408:0
CREATE OR REPLACE FUNCTION zdb."geo_bounds_agg"("aggregate_name" text, "field" text, "wrap_longitude" bool) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'geo_bounds_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:425:0
CREATE OR REPLACE FUNCTION zdb."value_count_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'value_count_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:441:0
CREATE OR REPLACE FUNCTION zdb."boxplot_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'boxplot_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:456:0
CREATE OR REPLACE FUNCTION zdb."boxplot_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'boxplot_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:472:0
CREATE OR REPLACE FUNCTION zdb."boxplot_agg"("aggregate_name" text, "field" text, "compression" bigint, "missing" bigint) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'boxplot_compression_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:495:0
CREATE OR REPLACE FUNCTION zdb."geo_centroid_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'geo_centroid_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:511:0
CREATE OR REPLACE FUNCTION zdb."median_absolute_deviation_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'median_absolute_deviation_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:527:0
CREATE OR REPLACE FUNCTION zdb."median_absolute_deviation_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'median_absolute_deviation_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:543:0
CREATE OR REPLACE FUNCTION zdb."median_absolute_deviation_agg"("aggregate_name" text, "field" text, "compression" bigint, "missing" bigint) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'median_absolute_deviation_compression_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:566:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_agg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."percentiles"("aggregate_name" text, "field" text, "keyed" bool) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_keyed_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:613:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:629:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text, "percents" double precision[], "keyed" bool) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_precent_keyed_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:651:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text, "precents" double precision[], "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_precent_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:673:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text, "keyed" bool, "missing" bigint) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_keyed_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:695:0
CREATE OR REPLACE FUNCTION zdb."percentiles_agg"("aggregate_name" text, "field" text, "percents" double precision[], "keyed" bool, "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_precents_keyed_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:720:0
CREATE OR REPLACE FUNCTION zdb."string_stats_agg"("aggregate_name" text, "field" text) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'string_stats_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:737:0
CREATE OR REPLACE FUNCTION zdb."string_stats_agg"("aggregate_name" text, "field" text, "show_distribution" bool) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'string_stats_char_distribution_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:757:0
CREATE OR REPLACE FUNCTION zdb."string_stats_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'string_stats_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:773:0
CREATE OR REPLACE FUNCTION zdb."string_stats_agg"("aggregate_name" text, "field" text, "show_distribution" bool, "missing" bigint) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'string_stats_char_distribution_missing_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:796:0
CREATE OR REPLACE FUNCTION zdb."weighted_avg_agg"("aggregate_name" text, "field_value" text, "field_weight" text) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'weighted_avg_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:814:0
CREATE OR REPLACE FUNCTION zdb."weighted_avg_agg"("aggregate_name" text, "field_value" text, "field_weight" text, "value_missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'weighted_avg_missing_value_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:839:0
CREATE OR REPLACE FUNCTION zdb."weighted_avg_agg"("aggregate_name" text, "field_value" text, "field_weight" text, "value_missing" bigint, "weight_missing" bigint) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'weighted_avg_missings_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:866:0
CREATE OR REPLACE FUNCTION zdb."top_metrics_agg"("aggregate_name" text, "metric_field" text, "sort_type" SortDescriptor) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'top_metric_sort_desc_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:889:0
CREATE OR REPLACE FUNCTION zdb."top_metrics_agg"("aggregate_name" text, "metric_field" text) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'top_metric_score_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:907:0
CREATE OR REPLACE FUNCTION zdb."top_metrics_agg"("aggregate_name" text, "metric_field" text, "sort_type_lat_long" double precision[]) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'top_metric_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:930:0
CREATE OR REPLACE FUNCTION zdb."t_test_agg"("aggregate_name" text, "fields" text[], "t_type" TTestType) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 't_test_fields_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:952:0
CREATE OR REPLACE FUNCTION zdb."t_test_agg"("aggregate_name" text, "fields" text[], "queries" ZDBQuery[], "t_type" TTestType) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 't_test_fields_queries_agg_wrapper';
