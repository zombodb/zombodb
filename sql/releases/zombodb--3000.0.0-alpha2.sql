...
--
-- ./src/lib.rs:42:0
CREATE OR REPLACE FUNCTION zdb."version"() RETURNS text IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'version_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_json"("input" json) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_json_wrapper';
-- ./src/zdbquery/cast.rs:15:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_jsonb"("input" JsonB) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_jsonb_wrapper';
-- ./src/zdbquery/cast.rs:20:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_to_json"("input" ZDBQuery) RETURNS json STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_to_json_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."point_to_json"("point" point) RETURNS json STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'point_to_json_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."geo_shape"("field" text, "geojson_shape" json, "relation" GeoShapeRelation) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'geo_shape_wrapper';
-- ./src/query_dsl/geo.rs:57:4
CREATE OR REPLACE FUNCTION dsl."geo_bounding_box"("field" text, "bounding_box" box, "box_type" GeoBoundingBoxType DEFAULT 'memory') RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'geo_bounding_box_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."anyelement_cmpfunc"("element" anyelement, "query" ZDBQuery) RETURNS bool IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'anyelement_cmpfunc_wrapper';
-- ./src/zdbquery/opclass.rs:67:0
CREATE OR REPLACE FUNCTION zdb."restrict"("root" internal, "_operator_oid" oid, "args" internal, "var_relid" integer) RETURNS double precision STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'restrict_wrapper';
...
--
-- ./src/misc/mod.rs:5:0
CREATE OR REPLACE FUNCTION zdb."query_tids"("index" regclass, "query" ZDBQuery) RETURNS tid[] STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'query_tids_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC smallint[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i16_wrapper';
-- ./src/query_dsl/terms.rs:38:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC integer[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i32_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC real[]) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_f32_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."prefix"("field" text, "value" text) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'prefix_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."field_exists"("field" text) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'field_exists_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."field_missing"("field" text) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'field_missing_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match_all"("boost" real DEFAULT '1.0') RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'match_all_wrapper';
-- ./src/query_dsl/match_all.rs:28:4
CREATE OR REPLACE FUNCTION dsl."match_none"() RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'match_none_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."limit"("limit" bigint, "query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'limit_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."row_estimate"("row_estimate" bigint, "query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'row_estimate_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."sort"("sort_field" text, "sort_direction" SortDirection, "zdbquery" ZDBQuery) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'sort_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."fuzzy"("field" text, "value" text, "boost" real DEFAULT NULL, "fuzziness" bigint DEFAULT NULL, "prefix_length" bigint DEFAULT NULL, "max_expansions" bigint DEFAULT '50', "transpositions" bool DEFAULT NULL) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'fuzzy_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_multi"("query" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_multi_wrapper';
-- ./src/query_dsl/span.rs:54:4
CREATE OR REPLACE FUNCTION dsl."span_near"("in_order" bool, "slop" bigint, "clauses" VARIADIC ZDBQuery[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'span_near_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_or"("clauses" VARIADIC ZDBQuery[]) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_or_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_within"("little" ZDBQuery, "big" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_within_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."range"("field" text, "lt" text DEFAULT NULL, "gt" text DEFAULT NULL, "lte" text DEFAULT NULL, "gte" text DEFAULT NULL, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'range_str_wrapper';
-- ./src/query_dsl/range.rs:66:4
CREATE OR REPLACE FUNCTION dsl."range"("field" text, "lt" bigint DEFAULT NULL, "gt" bigint DEFAULT NULL, "lte" bigint DEFAULT NULL, "gte" bigint DEFAULT NULL, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'range_numeric_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."constant_score"("query" ZDBQuery, "boost" real DEFAULT NULL) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'constant_score_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."must"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'must_wrapper';
-- ./src/query_dsl/bool.rs:81:4
CREATE OR REPLACE FUNCTION dsl."must_not"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'must_not_wrapper';
-- ./src/query_dsl/bool.rs:100:4
CREATE OR REPLACE FUNCTION dsl."filter"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'filter_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."not"("queries" VARIADIC ZDBQuery[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'not_wrapper';
-- ./src/query_dsl/bool.rs:190:4
CREATE OR REPLACE FUNCTION dsl."noteq"("query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'noteq_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match"("field" text, "query" text, "boost" real DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "lenient" bool DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "fuzzy_rewrite" text DEFAULT NULL, "fuzzy_transpositions" bool DEFAULT NULL, "prefix_length" integer DEFAULT NULL, "cutoff_frequency" real DEFAULT NULL, "auto_generate_synonyms_phrase_query" bool DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL, "operator" Operator DEFAULT NULL) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'match_wrapper_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."datetime_range"("field" text, "lt" time DEFAULT NULL, "gt" time DEFAULT NULL, "lte" time DEFAULT NULL, "gte" time DEFAULT NULL, "boost" real DEFAULT NULL, "relation" Relation DEFAULT 'intersects') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'datetime_range_time_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."more_like_this"("like" text[], "stop_words" text[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], "fields" text[] DEFAULT NULL, "boost" real DEFAULT NULL, "unlike" text DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "boost_terms" real DEFAULT NULL, "include" bool DEFAULT NULL, "min_term_freq" bigint DEFAULT NULL, "max_query_terms" bigint DEFAULT NULL, "min_doc_freq" bigint DEFAULT NULL, "max_doc_freq" bigint DEFAULT NULL, "min_word_length" bigint DEFAULT NULL, "max_word_length" bigint DEFAULT NULL) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'more_like_this_with_array_wrapper';
-- ./src/query_dsl/more_like_this.rs:121:4
CREATE OR REPLACE FUNCTION dsl."more_like_this"("like" text, "fields" text[] DEFAULT null, "stop_words" text[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], "boost" real DEFAULT NULL, "unlike" text DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "boost_terms" real DEFAULT NULL, "include" bool DEFAULT NULL, "min_term_freq" bigint DEFAULT NULL, "max_query_terms" bigint DEFAULT NULL, "min_doc_freq" bigint DEFAULT NULL, "max_doc_freq" bigint DEFAULT NULL, "min_word_length" bigint DEFAULT NULL, "max_word_length" bigint DEFAULT NULL) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'more_like_this_without_array_wrapper';
...
-- ./src/elasticsearch/mod.rs:434:0
CREATE OR REPLACE FUNCTION zdb."request"("index" regclass, "endpoint" text, "method" ArbitraryRequestType DEFAULT 'GET', "post_data" text DEFAULT NULL) RETURNS text PARALLEL SAFE VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'request_wrapper';
...
-- ./src/access_method/triggers.rs:52:0
...
CREATE OR REPLACE FUNCTION zdb."adjacency_matrix"("index" regclass, "labels" text[], "filters" ZDBQuery[]) RETURNS TABLE ("term" text, "doc_count" bigint) PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'adjacency_matrix_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."arbitrary_agg"("index" regclass, "query" ZDBQuery, "json" json) RETURNS json PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'arbitrary_agg_wrapper';
...
--
-- ./src/access_method/options.rs:317:0
...
-- ./src/access_method/options.rs:322:0
...
-- ./src/access_method/options.rs:329:0
CREATE OR REPLACE FUNCTION zdb."index_alias"("index_relation" regclass) RETURNS text VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_alias_wrapper';
-- ./src/access_method/options.rs:336:0
CREATE OR REPLACE FUNCTION zdb."index_url"("index_relation" regclass) RETURNS text PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_url_wrapper';
-- ./src/access_method/options.rs:343:0
CREATE OR REPLACE FUNCTION zdb."index_type_name"("index_relation" regclass) RETURNS text STRICT PARALLEL SAFE VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'index_type_name_wrapper';
-- ./src/access_method/options.rs:350:0
...
-- ./src/access_method/options.rs:360:0
CREATE OR REPLACE FUNCTION zdb."index_settings"("index_relation" regclass) RETURNS JsonB VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_settings_wrapper';
-- ./src/access_method/options.rs:370:0
...
-- ./src/access_method/options.rs:377:0
...
-- ./src/access_method/options.rs:387:0
CREATE OR REPLACE FUNCTION zdb."field_mapping"("index_relation" regclass, "field" text) RETURNS JsonB VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'field_mapping_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."percentiles"("index" regclass, "field" text, "query" ZDBQuery, "percents" json DEFAULT NULL) RETURNS TABLE ("key" double precision, "value" numeric) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'percentiles_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."percentile_ranks"("index" regclass, "field" text, "query" ZDBQuery, "values" json) RETURNS TABLE ("key" double precision, "value" numeric) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'percentile_ranks_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."terms_two_level"("index" regclass, "field_first" text, "field_second" text, "query" ZDBQuery, "order_by" TwoLevelTermsOrderBy DEFAULT NULL, "size_limit" integer DEFAULT '2147483647') RETURNS TABLE ("term_one" text, "term_two" text, "doc_count" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_two_level_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."filters"("index" regclass, "labels" text[], "filters" ZDBQuery[]) RETURNS TABLE ("term" text, "doc_count" bigint) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'filters_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."sum"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'sum_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:36:0
CREATE OR REPLACE FUNCTION zdb."avg"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'avg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."value_count"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'value_count_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."stats"("index" regclass, "field" text, "query" ZDBQuery) RETURNS TABLE ("count" bigint, "min" numeric, "max" numeric, "avg" numeric, "sum" numeric) PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'stats_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" tid, "score" double precision, "source" json) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits_with_id"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" text, "score" double precision, "source" json) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_with_id_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."ip_range"("index" regclass, "field" text, "query" ZDBQuery, "range_array" json) RETURNS TABLE ("key" text, "from" inet, "to" inet, "doc_count" bigint) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'ip_range_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."query"("index" regclass, "query" ZDBQuery) RETURNS SETOF tid STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'query_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."analyze_with_field"("index" regclass, "field" text, "text" text) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_with_field_wrapper';
...
--
-- ./src/cat/mod.rs:5:0
CREATE OR REPLACE FUNCTION zdb."cat_request"("index" regclass, "endpoint" text) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'cat_request_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."highlight"("ctid" tid, "field" text, "_highlight_definition" json DEFAULT zdb . highlight ()) RETURNS text[] STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_field_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."dump_query"("index" regclass, "query" ZDBQuery) RETURNS text IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'dump_query_wrapper';
-- ./src/query_parser/dsl/mod.rs:20:0
CREATE OR REPLACE FUNCTION zdb."debug_query"("index" regclass, "query" text) RETURNS TABLE ("normalized_query" text, "used_fields" text[], "ast" text) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'debug_query_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."zdb"("index" regclass, "input" text) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdb_wrapper';
...
-- ./src/elasticsearch/suggest_term.rs:95:0
CREATE OR REPLACE FUNCTION zdb."suggest_terms"("index" regclass, "field_name" text, "suggest" text, "query" ZDBQuery) RETURNS TABLE ("text" text, "offset" bigint, "length" bigint, "options" SuggestTermsOptions[]) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'suggest_terms_wrapper';
