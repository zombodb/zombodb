...
CREATE OR REPLACE FUNCTION zdb."score"(
	"ctid" tid /* core::option::Option<pgx_pg_sys::pg13::ItemPointerData> */
) RETURNS double precision /* f64 */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION zdb."point_to_json"(
	"point" point /* pgx_pg_sys::pg13::Point */
) RETURNS json /* pgx::datum::json::Json */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION zdb."point_array_to_json"(
	"points" point[] /* pgx::datum::array::Array<pgx_pg_sys::pg13::Point> */
) RETURNS json /* pgx::datum::json::Json */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION zdb."ctid"(
	"as_u64" bigint /* i64 */
) RETURNS tid /* pgx_pg_sys::pg13::ItemPointerData */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
-- src/access_method/triggers.rs:59
-- zombodb::access_method::triggers::zdb_delete_trigger
-- CREATE OR REPLACE FUNCTION zdb."zdb_delete_trigger"() RETURNS trigger
-- STRICT
-- LANGUAGE c /* Rust */
-- AS 'MODULE_PATHNAME', 'zdb_delete_trigger_wrapper';
--
...
-- CREATE OR REPLACE FUNCTION zdb."zdb_update_trigger"() RETURNS trigger
-- STRICT
-- LANGUAGE c /* Rust */
-- AS 'MODULE_PATHNAME', 'zdb_update_trigger_wrapper';
--
-- Overridden as (due to a `///` comment with a `pgxsql` code block):
...
-- CREATE OR REPLACE FUNCTION zdb."amhandler"() RETURNS internal /* pgx::pgbox::PgBox<pgx_pg_sys::pg13::IndexAmRoutine> */
-- STRICT
-- LANGUAGE c /* Rust */
-- AS 'MODULE_PATHNAME', 'amhandler_wrapper';
--
-- Overridden as (due to a `///` comment with a `pgxsql` code block):
...
CREATE OR REPLACE FUNCTION zdb."query_tids"(
	"index" regclass, /* pgx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS tid[] /* alloc::vec::Vec<pgx_pg_sys::pg13::ItemPointerData> */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION zdb."query"(
	"index" regclass, /* pgx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS SETOF tid /* pgx_pg_sys::pg13::ItemPointerData */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION zdb."top_hits"(
	...
	"id" tid,  /* pgx_pg_sys::pg13::ItemPointerData */
	"score" double precision,  /* f64 */
	"source" json  /* pgx::datum::json::Json */
)
IMMUTABLE PARALLEL SAFE STRICT
...
CREATE OR REPLACE FUNCTION dsl."geo_polygon"(
	"field" text, /* &str */
	"points" VARIADIC point[] /* pgx::datum::array::Array<pgx_pg_sys::pg13::Point> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
...
CREATE OR REPLACE FUNCTION dsl."geo_bounding_box"(
	"field" text, /* &str */
	"bounding_box" box, /* pgx_pg_sys::pg13::BOX */
...
CREATE OR REPLACE FUNCTION zdb."highlight"(
	"ctid" tid, /* pgx_pg_sys::pg13::ItemPointerData */
	"field" text, /* &str */
...
-- src/elasticsearch/aggregates/terms.rs:367
...
-- ) RETURNS text[] /* alloc::vec::Vec<core::option::Option<alloc::string::String>> */
-- IMMUTABLE PARALLEL SAFE
-- LANGUAGE c /* Rust */
-- AS 'MODULE_PATHNAME', 'terms_array_agg_wrapper';
--
-- Overridden as (due to a `///` comment with a `pgxsql` code block):
