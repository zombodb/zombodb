...
--
-- ./src/lib.rs:42:0
CREATE OR REPLACE FUNCTION zdb."internal_version"() RETURNS text PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'internal_version_wrapper';
-- ./src/lib.rs:63:0
CREATE OR REPLACE FUNCTION zdb."ctid"("as_u64" bigint) RETURNS tid STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'ctid_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."to_query_dsl"("query" ZDBQuery) RETURNS json STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'to_query_dsl_wrapper';
-- ./src/zdbquery/mod.rs:885:0
CREATE OR REPLACE FUNCTION zdb."to_queries_dsl"("queries" ZDBQuery[]) RETURNS json[] PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'to_queries_dsl_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_text"("input" text) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_text_wrapper';
-- ./src/zdbquery/cast.rs:10:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_json"("input" json) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_json_wrapper';
-- ./src/zdbquery/cast.rs:15:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_from_jsonb"("input" JsonB) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_from_jsonb_wrapper';
-- ./src/zdbquery/cast.rs:20:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_to_json"("input" ZDBQuery) RETURNS json PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_to_json_wrapper';
-- ./src/zdbquery/cast.rs:25:0
CREATE OR REPLACE FUNCTION zdb."zdbquery_to_jsonb"("input" ZDBQuery) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdbquery_to_jsonb_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."point_to_json"("point" point) RETURNS json IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'point_to_json_wrapper';
-- ./src/query_dsl/geo.rs:29:0
CREATE OR REPLACE FUNCTION zdb."point_array_to_json"("points" point[]) RETURNS json STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'point_array_to_json_wrapper';
CREATE SCHEMA IF NOT EXISTS "dsl";
-- ./src/query_dsl/geo.rs:43:4
CREATE OR REPLACE FUNCTION dsl."geo_shape"("field" text, "geojson_shape" json, "relation" GeoShapeRelation) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'geo_shape_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."anyelement_cmpfunc"("element" anyelement, "query" ZDBQuery) RETURNS bool STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'anyelement_cmpfunc_wrapper';
-- ./src/zdbquery/opclass.rs:68:0
CREATE OR REPLACE FUNCTION zdb."restrict"("root" internal, "_operator_oid" oid, "args" internal, "var_relid" integer) RETURNS double precision IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'restrict_wrapper';
...
--
-- ./src/misc/mod.rs:5:0
CREATE OR REPLACE FUNCTION zdb."query_tids"("index" regclass, "query" ZDBQuery) RETURNS tid[] IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'query_tids_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" text, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_str_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" smallint, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_i16_wrapper';
-- ./src/query_dsl/term.rs:61:4
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" integer, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_i32_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" real, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_f32_wrapper';
-- ./src/query_dsl/term.rs:100:4
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" double precision, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_f64_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" date, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_date_wrapper';
-- ./src/query_dsl/term.rs:139:4
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" time with time zone, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_time_with_timezone_wrapper';
-- ./src/query_dsl/term.rs:152:4
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" timestamp without time zone, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_timestamp_wrapper';
-- ./src/query_dsl/term.rs:165:4
CREATE OR REPLACE FUNCTION dsl."term"("field" text, "value" timestamp with time zone, "boost" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'term_timestamp_with_timezone_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC text[]) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_str_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC smallint[]) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i16_wrapper';
-- ./src/query_dsl/terms.rs:38:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC integer[]) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i32_wrapper';
-- ./src/query_dsl/terms.rs:46:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC bigint[]) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_i64_wrapper';
-- ./src/query_dsl/terms.rs:54:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC real[]) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_f32_wrapper';
-- ./src/query_dsl/terms.rs:62:4
CREATE OR REPLACE FUNCTION dsl."terms"("field" text, "values" VARIADIC double precision[]) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_f64_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."prefix"("field" text, "value" text) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'prefix_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."field_exists"("field" text) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'field_exists_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match_all"("boost" real DEFAULT '1.0') RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'match_all_wrapper';
-- ./src/query_dsl/match_all.rs:28:4
CREATE OR REPLACE FUNCTION dsl."match_none"() RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'match_none_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms_array"("fieldname" text, "array" anyarray) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'terms_array_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."terms_lookup"("field" text, "index" text, "id" text, "path" text, "routing" text DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_lookup_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."limit"("limit" bigint, "query" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'limit_wrapper';
-- ./src/query_dsl/limit.rs:13:4
CREATE OR REPLACE FUNCTION dsl."offset"("offset" bigint, "query" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'offset_wrapper';
-- ./src/query_dsl/limit.rs:21:4
CREATE OR REPLACE FUNCTION dsl."offset_limit"("offset" bigint, "limit" bigint, "query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'offset_limit_wrapper';
-- ./src/query_dsl/limit.rs:27:4
CREATE OR REPLACE FUNCTION dsl."min_score"("min_score" double precision, "query" ZDBQuery) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'min_score_wrapper';
-- ./src/query_dsl/limit.rs:32:4
CREATE OR REPLACE FUNCTION dsl."row_estimate"("row_estimate" bigint, "query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'row_estimate_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."sd"("field" text, "order" SortDirection, "mode" SortMode DEFAULT NULL) RETURNS SortDescriptor PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'sd_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."sort_many"("zdbquery" ZDBQuery, "sort_descriptors" VARIADIC SortDescriptor[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'sort_many_wrapper';
-- ./src/query_dsl/sort.rs:70:4
CREATE OR REPLACE FUNCTION dsl."sort_direct"("sort_json" json, "zdbquery" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'sort_direct_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_containing"("little" ZDBQuery, "big" ZDBQuery) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_containing_wrapper';
-- ./src/query_dsl/span.rs:24:4
CREATE OR REPLACE FUNCTION dsl."span_first"("query" ZDBQuery, "end" bigint) RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'span_first_wrapper';
-- ./src/query_dsl/span.rs:34:4
CREATE OR REPLACE FUNCTION dsl."span_masking"("field" text, "query" ZDBQuery) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'span_masking_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."span_within"("little" ZDBQuery, "big" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'span_within_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."wildcard"("field" text, "value" text, "boost" real DEFAULT '1.0') RETURNS ZDBQuery IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'wildcard_wrapper';
-- ./src/query_dsl/misc.rs:61:4
CREATE OR REPLACE FUNCTION dsl."regexp"("field" text, "regexp" text, "boost" real DEFAULT NULL, "flags" RegexFlags[] DEFAULT NULL, "max_determinized_states" integer DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'regexp_wrapper';
-- ./src/query_dsl/misc.rs:84:4
CREATE OR REPLACE FUNCTION dsl."script"("source" text, "params" json DEFAULT NULL, "lang" text DEFAULT 'painless') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'script_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."constant_score"("query" ZDBQuery, "boost" real DEFAULT NULL) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'constant_score_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."dis_max"("queries" ZDBQuery[], "boost" real DEFAULT NULL, "tie_breaker" real DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'dis_max_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."bool"("parts" VARIADIC BoolQueryPart[]) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'bool_wrapper';
-- ./src/query_dsl/bool.rs:43:4
CREATE OR REPLACE FUNCTION dsl."should"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'should_wrapper';
-- ./src/query_dsl/bool.rs:62:4
CREATE OR REPLACE FUNCTION dsl."must"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'must_wrapper';
-- ./src/query_dsl/bool.rs:81:4
CREATE OR REPLACE FUNCTION dsl."must_not"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'must_not_wrapper';
-- ./src/query_dsl/bool.rs:100:4
CREATE OR REPLACE FUNCTION dsl."filter"("queries" VARIADIC ZDBQuery[]) RETURNS BoolQueryPart STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'filter_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."and"("queries" VARIADIC ZDBQuery[]) RETURNS ZDBQuery STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'and_wrapper';
-- ./src/query_dsl/bool.rs:152:4
CREATE OR REPLACE FUNCTION dsl."or"("queries" VARIADIC ZDBQuery[]) RETURNS ZDBQuery STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'or_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."noteq"("query" ZDBQuery) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'noteq_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."match"("field" text, "query" text, "boost" real DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "lenient" bool DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "fuzzy_rewrite" text DEFAULT NULL, "fuzzy_transpositions" bool DEFAULT NULL, "prefix_length" integer DEFAULT NULL, "cutoff_frequency" real DEFAULT NULL, "auto_generate_synonyms_phrase_query" bool DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL, "operator" Operator DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'match_wrapper_wrapper';
-- ./src/query_dsl/matches.rs:171:4
CREATE OR REPLACE FUNCTION dsl."multi_match"("fields" text[], "query" text, "boost" real DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "lenient" bool DEFAULT NULL, "fuzziness" integer DEFAULT NULL, "fuzzy_rewrite" text DEFAULT NULL, "fuzzy_transpositions" bool DEFAULT NULL, "prefix_length" integer DEFAULT NULL, "cutoff_frequency" real DEFAULT NULL, "auto_generate_synonyms_phrase_query" bool DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL, "operator" Operator DEFAULT NULL, "match_type" MatchType DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'multi_match_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."phrase"("field" text, "query" text, "boost" real DEFAULT NULL, "slop" integer DEFAULT NULL, "analyzer" text DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'phrase_wrapper';
-- ./src/query_dsl/matches.rs:250:4
CREATE OR REPLACE FUNCTION dsl."match_phrase_prefix"("field" text, "query" text, "boost" real DEFAULT NULL, "slop" integer DEFAULT NULL, "analyzer" text DEFAULT NULL, "maxexpansion" integer DEFAULT NULL, "zero_terms_query" ZeroTermsQuery DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'match_phrase_prefix_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."nested"("path" text, "query" ZDBQuery, "score_mode" ScoreMode DEFAULT 'avg', "ignore_unmapped" bool DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'nested_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."datetime_range"("field" text, "lt" date DEFAULT NULL, "gt" date DEFAULT NULL, "lte" date DEFAULT NULL, "gte" date DEFAULT NULL, "boost" real DEFAULT NULL, "relation" Relation DEFAULT 'intersects') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'datetime_range_date_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."datetime_range"("field" text, "lt" timestamp without time zone DEFAULT NULL, "gt" timestamp without time zone DEFAULT NULL, "lte" timestamp without time zone DEFAULT NULL, "gte" timestamp without time zone DEFAULT NULL, "boost" real DEFAULT NULL, "relation" Relation DEFAULT 'intersects') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'datetime_range_time_stamp_wrapper';
-- ./src/query_dsl/datetime_range.rs:111:4
CREATE OR REPLACE FUNCTION dsl."datetime_range"("field" text, "lt" timestamp with time zone DEFAULT NULL, "gt" timestamp with time zone DEFAULT NULL, "lte" timestamp with time zone DEFAULT NULL, "gte" timestamp with time zone DEFAULT NULL, "boost" real DEFAULT NULL, "relation" Relation DEFAULT 'intersects') RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'datetime_range_timestamp_with_timezone_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."more_like_this"("like" text[], "stop_words" text[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], "fields" text[] DEFAULT NULL, "boost" real DEFAULT NULL, "unlike" text DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "boost_terms" real DEFAULT NULL, "include" bool DEFAULT NULL, "min_term_freq" bigint DEFAULT NULL, "max_query_terms" bigint DEFAULT NULL, "min_doc_freq" bigint DEFAULT NULL, "max_doc_freq" bigint DEFAULT NULL, "min_word_length" bigint DEFAULT NULL, "max_word_length" bigint DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'more_like_this_with_array_wrapper';
-- ./src/query_dsl/more_like_this.rs:121:4
CREATE OR REPLACE FUNCTION dsl."more_like_this"("like" text, "fields" text[] DEFAULT null, "stop_words" text[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], "boost" real DEFAULT NULL, "unlike" text DEFAULT NULL, "analyzer" text DEFAULT NULL, "minimum_should_match" text DEFAULT NULL, "boost_terms" real DEFAULT NULL, "include" bool DEFAULT NULL, "min_term_freq" bigint DEFAULT NULL, "max_query_terms" bigint DEFAULT NULL, "min_doc_freq" bigint DEFAULT NULL, "max_doc_freq" bigint DEFAULT NULL, "min_word_length" bigint DEFAULT NULL, "max_word_length" bigint DEFAULT NULL) RETURNS ZDBQuery PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'more_like_this_without_array_wrapper';
...
-- ./src/elasticsearch/mod.rs:495:0
CREATE OR REPLACE FUNCTION zdb."request"("index" regclass, "endpoint" text, "method" ArbitraryRequestType DEFAULT 'GET', "post_data" JsonB DEFAULT NULL, "null_on_error" bool DEFAULT 'false') RETURNS text PARALLEL SAFE VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'request_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."profile_query"("index" regclass, "query" ZDBQuery) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'profile_query_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."terms"("index" regclass, "field_name" text, "query" ZDBQuery, "size_limit" integer DEFAULT '2147483647', "order_by" TermsOrderBy DEFAULT NULL) RETURNS TABLE ("term" text, "doc_count" bigint) IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."significant_terms"("index" regclass, "field" text, "query" ZDBQuery, "include" text DEFAULT '.*', "size_limit" integer DEFAULT '2147483647', "min_doc_count" integer DEFAULT '3') RETURNS TABLE ("term" text, "doc_count" bigint, "score" real, "bg_count" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'significant_terms_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."significant_text"("index" regclass, "field" text, "query" ZDBQuery, "size" integer DEFAULT '10', "filter_duplicate_text" bool DEFAULT 'true') RETURNS TABLE ("term" text, "doc_count" bigint, "score" double precision, "bg_count" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'significant_text_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."histogram"("index" regclass, "field" text, "query" ZDBQuery, "interval" double precision, "min_doc_count" integer DEFAULT '0') RETURNS TABLE ("term" numeric, "doc_count" bigint) PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'histogram_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."adjacency_matrix"("index" regclass, "labels" text[], "filters" ZDBQuery[]) RETURNS TABLE ("term" text, "doc_count" bigint) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'adjacency_matrix_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."arbitrary_agg"("index" regclass, "query" ZDBQuery, "json" JsonB) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'arbitrary_agg_wrapper';
...
--
-- ./src/access_method/options.rs:416:0
/*
...
*/
-- ./src/access_method/options.rs:427:0
CREATE OR REPLACE FUNCTION zdb."determine_index"("relation" regclass) RETURNS regclass PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'determine_index_wrapper';
-- ./src/access_method/options.rs:437:0
CREATE OR REPLACE FUNCTION zdb."index_links"("relation" regclass) RETURNS text[] VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_links_wrapper';
-- ./src/access_method/options.rs:443:0
CREATE OR REPLACE FUNCTION zdb."index_name"("index_relation" regclass) RETURNS text VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_name_wrapper';
-- ./src/access_method/options.rs:450:0
CREATE OR REPLACE FUNCTION zdb."index_alias"("index_relation" regclass) RETURNS text PARALLEL SAFE STRICT VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'index_alias_wrapper';
-- ./src/access_method/options.rs:457:0
CREATE OR REPLACE FUNCTION zdb."index_url"("index_relation" regclass) RETURNS text STRICT PARALLEL SAFE VOLATILE LANGUAGE c AS 'MODULE_PATHNAME', 'index_url_wrapper';
-- ./src/access_method/options.rs:464:0
CREATE OR REPLACE FUNCTION zdb."index_type_name"("index_relation" regclass) RETURNS text VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_type_name_wrapper';
-- ./src/access_method/options.rs:471:0
CREATE OR REPLACE FUNCTION zdb."index_mapping"("index_relation" regclass) RETURNS JsonB VOLATILE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_mapping_wrapper';
-- ./src/access_method/options.rs:481:0
...
-- ./src/access_method/options.rs:491:0
CREATE OR REPLACE FUNCTION zdb."index_options"("index_relation" regclass) RETURNS text[] VOLATILE STRICT PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'index_options_wrapper';
-- ./src/access_method/options.rs:498:0
CREATE OR REPLACE FUNCTION zdb."index_field_lists"("index_relation" regclass) RETURNS TABLE ("fieldname" text, "fields" text[]) PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'index_field_lists_wrapper';
-- ./src/access_method/options.rs:508:0
CREATE OR REPLACE FUNCTION zdb."field_mapping"("index_relation" regclass, "field" text) RETURNS JsonB PARALLEL SAFE VOLATILE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'field_mapping_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."count"("index" regclass, "query" ZDBQuery) RETURNS bigint STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'count_wrapper';
-- ./src/elasticsearch/aggregates/count.rs:17:0
CREATE OR REPLACE FUNCTION zdb."raw_count"("index" regclass, "query" ZDBQuery) RETURNS bigint PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'raw_count_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."percentile_ranks"("index" regclass, "field" text, "query" ZDBQuery, "values" json) RETURNS TABLE ("key" double precision, "value" numeric) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'percentile_ranks_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."terms_two_level"("index" regclass, "field_first" text, "field_second" text, "query" ZDBQuery, "order_by" TwoLevelTermsOrderBy DEFAULT NULL, "size_limit" integer DEFAULT '2147483647') RETURNS TABLE ("term_one" text, "term_two" text, "doc_count" bigint) IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_two_level_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."matrix_stats"("index" regclass, "fields" text[], "query" ZDBQuery) RETURNS TABLE ("term" text, "count" bigint, "mean" numeric, "variance" numeric, "skewness" numeric, "kurtosis" numeric, "covariance" json, "correlation" json) STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'matrix_stats_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."avg"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'avg_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:65:0
CREATE OR REPLACE FUNCTION zdb."cardinality"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'cardinality_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:94:0
CREATE OR REPLACE FUNCTION zdb."max"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'max_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:123:0
CREATE OR REPLACE FUNCTION zdb."min"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'min_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:152:0
CREATE OR REPLACE FUNCTION zdb."missing"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'missing_wrapper';
-- ./src/elasticsearch/aggregates/metrics.rs:181:0
CREATE OR REPLACE FUNCTION zdb."value_count"("index" regclass, "field" text, "query" ZDBQuery) RETURNS numeric IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'value_count_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."stats"("index" regclass, "field" text, "query" ZDBQuery) RETURNS TABLE ("count" bigint, "min" numeric, "max" numeric, "avg" numeric, "sum" numeric) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'stats_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."date_range"("index" regclass, "field" text, "query" ZDBQuery, "date_range_array" json) RETURNS TABLE ("key" text, "from" numeric, "from_as_string" text, "to" numeric, "to_as_string" text, "doc_count" bigint) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'date_range_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" tid, "score" double precision, "source" json) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."top_hits_with_id"("index" regclass, "fields" text[], "query" ZDBQuery, "size_limit" bigint) RETURNS TABLE ("id" text, "score" double precision, "source" json) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'top_hits_with_id_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."query"("index" regclass, "query" ZDBQuery) RETURNS SETOF tid PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'query_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."analyze_text"("index" regclass, "analyzer" text, "text" text) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_text_wrapper';
-- ./src/elasticsearch/analyze.rs:137:0
CREATE OR REPLACE FUNCTION zdb."analyze_with_field"("index" regclass, "field" text, "text" text) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_with_field_wrapper';
-- ./src/elasticsearch/analyze.rs:156:0
CREATE OR REPLACE FUNCTION zdb."analyze_custom"("index" regclass, "field" text DEFAULT NULL, "text" text DEFAULT NULL, "tokenizer" text DEFAULT NULL, "normalizer" text DEFAULT NULL, "filter" text[] DEFAULT NULL, "char_filter" text[] DEFAULT NULL) RETURNS TABLE ("type" text, "token" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'analyze_custom_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."highlight_term"("index" regclass, "field_name" text, "text" text, "token_to_highlight" text) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_term_wrapper';
-- ./src/highlighting/document_highlighter.rs:499:0
CREATE OR REPLACE FUNCTION zdb."highlight_phrase"("index" regclass, "field_name" text, "text" text, "tokens_to_highlight" text) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_phrase_wrapper';
-- ./src/highlighting/document_highlighter.rs:537:0
CREATE OR REPLACE FUNCTION zdb."highlight_wildcard"("index" regclass, "field_name" text, "text" text, "token_to_highlight" text) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_wildcard_wrapper';
-- ./src/highlighting/document_highlighter.rs:575:0
CREATE OR REPLACE FUNCTION zdb."highlight_regex"("index" regclass, "field_name" text, "text" text, "token_to_highlight" text) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_regex_wrapper';
-- ./src/highlighting/document_highlighter.rs:613:0
CREATE OR REPLACE FUNCTION zdb."highlight_fuzzy"("index" regclass, "field_name" text, "text" text, "token_to_highlight" text, "prefix" integer) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_fuzzy_wrapper';
-- ./src/highlighting/document_highlighter.rs:656:0
CREATE OR REPLACE FUNCTION zdb."highlight_proximity"("index" regclass, "field_name" text, "text" text, "prox_clause" ProximityPart[]) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_proximity_wrapper';
...
--
-- ./src/cat/mod.rs:5:0
CREATE OR REPLACE FUNCTION zdb."cat_request"("index" regclass, "endpoint" text) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'cat_request_wrapper';
...
--
-- ./src/highlighting/query_highlighter.rs:321:0
CREATE OR REPLACE FUNCTION zdb."highlight_document"("index" regclass, "document" JsonB, "query_string" text) RETURNS TABLE ("field_name" text, "term" text, "type" text, "position" integer, "start_offset" bigint, "end_offset" bigint, "query_clause" text) STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'highlight_document_wrapper';
...
--
-- ./src/zql/dsl/mod.rs:15:0
CREATE OR REPLACE FUNCTION zdb."dump_query"("index" regclass, "query" ZDBQuery) RETURNS text PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'dump_query_wrapper';
-- ./src/zql/dsl/mod.rs:21:0
...
--
CREATE TYPE pg_catalog.suggesttermsoptions;
CREATE OR REPLACE FUNCTION pg_catalog.suggesttermsoptions_in(cstring) RETURNS pg_catalog.suggesttermsoptions IMMUTABLE STRICT PARALLEL SAFE LANGUAGE C AS 'MODULE_PATHNAME', 'suggesttermsoptions_in_wrapper';
CREATE OR REPLACE FUNCTION pg_catalog.suggesttermsoptions_out(pg_catalog.suggesttermsoptions) RETURNS cstring IMMUTABLE STRICT PARALLEL SAFE LANGUAGE C AS 'MODULE_PATHNAME', 'suggesttermsoptions_out_wrapper';
CREATE TYPE pg_catalog.suggesttermsoptions (
                                INTERNALLENGTH = variable,
                                INPUT = pg_catalog.suggesttermsoptions_in,
                                OUTPUT = pg_catalog.suggesttermsoptions_out,
                                STORAGE = extended
                            );
-- ./src/elasticsearch/suggest_term.rs:93:0
CREATE OR REPLACE FUNCTION zdb."suggest_terms"("index" regclass, "field_name" text, "suggest" text, "query" ZDBQuery) RETURNS TABLE ("text" text, "offset" bigint, "length" bigint, "options" SuggestTermsOptions[]) IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'suggest_terms_wrapper';
...
CREATE OR REPLACE FUNCTION dsl."zdb"("index" regclass, "input" text) RETURNS ZDBQuery PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'zdb_wrapper';
-- ./src/query_dsl/zdb.rs:29:4
CREATE OR REPLACE FUNCTION dsl."link_options"("options" text[], "query" ZDBQuery) RETURNS ZDBQuery STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'link_options_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."terms_agg"("aggregate_name" text, "field" text, "size_limit" integer, "order_by" TermsOrderBy, "children" JsonB[] DEFAULT NULL) RETURNS JsonB PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'terms_agg_wrapper';
...
--
-- ./src/elasticsearch/aggregates/builders/metrics.rs:21:0
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:36:0
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:52:0
CREATE OR REPLACE FUNCTION zdb."sum_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'sum_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:69:0
CREATE OR REPLACE FUNCTION zdb."avg_agg"("aggregate_name" text, "field" text) RETURNS JsonB STRICT PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'avg_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:84:0
CREATE OR REPLACE FUNCTION zdb."avg_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'avg_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:100:0
CREATE OR REPLACE FUNCTION zdb."avg_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'avg_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:117:0
CREATE OR REPLACE FUNCTION zdb."min_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'min_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:132:0
CREATE OR REPLACE FUNCTION zdb."min_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'min_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:148:0
CREATE OR REPLACE FUNCTION zdb."min_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'min_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:165:0
CREATE OR REPLACE FUNCTION zdb."max_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'max_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:180:0
CREATE OR REPLACE FUNCTION zdb."max_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'max_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:196:0
CREATE OR REPLACE FUNCTION zdb."max_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'max_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:213:0
...
CREATE OR REPLACE FUNCTION zdb."stats_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'stats_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:244:0
CREATE OR REPLACE FUNCTION zdb."stats_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'stats_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:261:0
CREATE OR REPLACE FUNCTION zdb."cardinality_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'cardinality_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:276:0
CREATE OR REPLACE FUNCTION zdb."cardinality_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'cardinality_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:292:0
CREATE OR REPLACE FUNCTION zdb."cardinality_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB PARALLEL SAFE STRICT IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'cardinality_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:309:0
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:324:0
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text, "missing" bigint) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_missing_int_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:340:0
CREATE OR REPLACE FUNCTION zdb."extended_stats_agg"("aggregate_name" text, "field" text, "missing" double precision) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'extended_stats_agg_missing_float_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:357:0
CREATE OR REPLACE FUNCTION zdb."matrix_stats_agg"("aggregate_name" text, "field" text[]) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'matrix_stats_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:371:0
CREATE OR REPLACE FUNCTION zdb."matrix_stats_agg"("aggregate_name" text, "field" text[], "missing_field" text, "missing_value" bigint) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'matrix_stats_agg_missing_i64_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:393:0
CREATE OR REPLACE FUNCTION zdb."geo_bounds_agg"("aggregate_name" text, "field" text, "wrap_longitude" bool) RETURNS JsonB PARALLEL SAFE IMMUTABLE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'geo_bounds_agg_wrapper';
-- ./src/elasticsearch/aggregates/builders/metrics.rs:410:0
CREATE OR REPLACE FUNCTION zdb."geo_bounds_agg"("aggregate_name" text, "field" text) RETURNS JsonB IMMUTABLE PARALLEL SAFE STRICT LANGUAGE c AS 'MODULE_PATHNAME', 'value_count_agg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."filter_agg"("index" regclass, "aggregate_name" text, "filter" ZDBQuery, "children" JsonB[] DEFAULT NULL) RETURNS JsonB PARALLEL SAFE IMMUTABLE LANGUAGE c AS 'MODULE_PATHNAME', 'filter_agg_wrapper';
...
CREATE OR REPLACE FUNCTION zdb."filters_agg"("index" regclass, "aggregate_name" text, "labels" text[], "filters" ZDBQuery[]) RETURNS JsonB STRICT IMMUTABLE PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', 'filters_agg_wrapper';
