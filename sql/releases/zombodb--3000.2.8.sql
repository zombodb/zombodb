...
CREATE TYPE ExecutionHint AS ENUM (
	'Map',
	'GlobalOrdinals',
	'BytesHash'
);
...
/* <begin connected objects> */
-- src/elasticsearch/analyze.rs:159
-- zombodb::elasticsearch::analyze::analyze_custom
CREATE  FUNCTION "analyze_custom"(
	...
	"char_filter" TEXT[] DEFAULT NULL /* core::option::Option<alloc::vec::Vec<alloc::string::String>> */
) RETURNS TABLE (
...
/* <begin connected objects> */
-- src/elasticsearch/analyze.rs:119
-- zombodb::elasticsearch::analyze::analyze_text
CREATE  FUNCTION "analyze_text"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"analyzer" TEXT, /* &str */
	"text" TEXT /* &str */
) RETURNS TABLE (
...
/* <begin connected objects> */
-- src/elasticsearch/analyze.rs:139
-- zombodb::elasticsearch::analyze::analyze_with_field
CREATE  FUNCTION "analyze_with_field"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"text" TEXT /* &str */
) RETURNS TABLE (
...
CREATE  FUNCTION "auto_date_histogram_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
	"buckets" bigint, /* i64 */
	"format" TEXT DEFAULT NULL, /* core::option::Option<&str> */
	"minimum_interval" Intervals DEFAULT NULL, /* core::option::Option<zombodb::elasticsearch::aggregates::builders::auto_date_histogram::Intervals> */
...
CREATE  FUNCTION "cardinality_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "ctid"(
	"as_u64" bigint /* i64 */
) RETURNS tid /* pgrx_pg_sys::include::pg14::ItemPointerData */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "date_range_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
	"format" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/access_method/options.rs:511
-- zombodb::access_method::options::determine_index
CREATE  FUNCTION "determine_index"(
	"relation" regclass /* pgrx::rel::PgRelation */
) RETURNS regclass /* core::option::Option<zombodb::access_method::options::ReturnedRegclass> */
...
CREATE  FUNCTION "diversified_sampler_agg"(
	"aggregate_name" TEXT, /* &str */
	"shard_size" bigint DEFAULT NULL, /* core::option::Option<i64> */
	"max_docs_per_value" bigint DEFAULT NULL, /* core::option::Option<i64> */
	"execution_hint" ExecutionHint DEFAULT NULL, /* core::option::Option<zombodb::elasticsearch::aggregates::builders::diversified_sampler::ExecutionHint> */
	"children" jsonb[] DEFAULT NULL /* core::option::Option<alloc::vec::Vec<pgrx::datum::json::JsonB>> */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "extended_stats_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
...
/* <begin connected objects> */
-- src/access_method/options.rs:594
-- zombodb::access_method::options::field_mapping
CREATE  FUNCTION "field_mapping"(
...
CREATE  FUNCTION "geo_bounds_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
...
CREATE  FUNCTION "geo_centroid_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "geo_distance_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
	"origin" TEXT, /* &str */
	"range" json[], /* alloc::vec::Vec<pgrx::datum::json::Json> */
...
CREATE  FUNCTION "geogrid_grid_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
...
CREATE  FUNCTION "geohash_grid_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
	"precision" smallint DEFAULT NULL, /* core::option::Option<i16> */
	"bounds" TEXT DEFAULT NULL, /* core::option::Option<&str> */
...
/* <begin connected objects> */
-- src/highlighting/query_highlighter.rs:544
-- zombodb::highlighting::query_highlighter::highlight_document
CREATE  FUNCTION "highlight_document"(
	"index" regclass, /* pgrx::rel::PgRelation */
...
/* <begin connected objects> */
-- src/highlighting/query_highlighter.rs:523
-- zombodb::highlighting::query_highlighter::highlight_document
CREATE  FUNCTION "highlight_document"(
	"index" regclass, /* pgrx::rel::PgRelation */
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:933
-- zombodb::highlighting::document_highlighter::highlight_fuzzy
CREATE  FUNCTION "highlight_fuzzy"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:813
-- zombodb::highlighting::document_highlighter::highlight_phrase
CREATE  FUNCTION "highlight_phrase"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
	"text" TEXT, /* alloc::string::String */
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:893
-- zombodb::highlighting::document_highlighter::highlight_regex
CREATE  FUNCTION "highlight_regex"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
	"text" TEXT, /* alloc::string::String */
	"token_to_highlight" TEXT /* &str */
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:773
-- zombodb::highlighting::document_highlighter::highlight_term
CREATE  FUNCTION "highlight_term"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
	"text" TEXT, /* alloc::string::String */
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:853
-- zombodb::highlighting::document_highlighter::highlight_wildcard
CREATE  FUNCTION "highlight_wildcard"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
	"text" TEXT, /* alloc::string::String */
	"token_to_highlight" TEXT /* &str */
...
/* <begin connected objects> */
-- src/access_method/options.rs:534
-- zombodb::access_method::options::index_alias
CREATE  FUNCTION "index_alias"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
...
/* <begin connected objects> */
-- src/access_method/options.rs:582
-- zombodb::access_method::options::index_field_lists
CREATE  FUNCTION "index_field_lists"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS TABLE (
...
/* <begin connected objects> */
-- src/access_method/options.rs:521
-- zombodb::access_method::options::index_links
CREATE  FUNCTION "index_links"(
	"relation" regclass /* pgrx::rel::PgRelation */
...
/* <begin connected objects> */
-- src/access_method/options.rs:555
-- zombodb::access_method::options::index_mapping
CREATE  FUNCTION "index_mapping"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
STRICT VOLATILE PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/access_method/options.rs:527
...
/* <begin connected objects> */
-- src/access_method/options.rs:575
-- zombodb::access_method::options::index_options
CREATE  FUNCTION "index_options"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS TEXT[] /* core::option::Option<alloc::vec::Vec<alloc::string::String>> */
STRICT VOLATILE PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/access_method/options.rs:565
-- zombodb::access_method::options::index_settings
CREATE  FUNCTION "index_settings"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
STRICT VOLATILE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "index_type_name"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS TEXT /* alloc::string::String */
STRICT VOLATILE PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/access_method/options.rs:541
-- zombodb::access_method::options::index_url
CREATE  FUNCTION "index_url"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS TEXT /* alloc::string::String */
STRICT VOLATILE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "internal_version"() RETURNS TEXT /* alloc::string::String */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "internal_visibility_clause"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
...
CREATE  FUNCTION "matrix_stats_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT[] /* alloc::vec::Vec<alloc::string::String> */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "median_absolute_deviation_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "percentiles_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "point_array_to_json"(
	"points" point[] /* pgrx::datum::array::Array<pgrx_pg_sys::include::pg14::Point> */
) RETURNS json /* pgrx::datum::json::Json */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "point_to_json"(
	"point" point /* pgrx_pg_sys::include::pg14::Point */
) RETURNS json /* pgrx::datum::json::Json */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/mapping/mod.rs:105
-- zombodb::mapping::reapply_mapping
CREATE  FUNCTION "reapply_mapping"(
	"index_relation" regclass /* pgrx::rel::PgRelation */
) RETURNS bool /* bool */
STRICT
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/zdbquery/opclass.rs:93
-- zombodb::zdbquery::opclass::restrict
CREATE  FUNCTION "restrict"(
...
CREATE  FUNCTION "score"(
	"ctid" tid /* core::option::Option<pgrx_pg_sys::include::pg14::ItemPointerData> */
) RETURNS double precision /* f64 */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/access_method/options.rs:479
...
CREATE  FUNCTION "string_stats_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "t_test_agg"(
	"aggregate_name" TEXT, /* &str */
	"fields" TEXT[], /* alloc::vec::Vec<alloc::string::String> */
	"t_type" TTestType /* zombodb::elasticsearch::aggregates::builders::metrics::TTestType */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "top_metrics_agg"(
	"aggregate_name" TEXT, /* &str */
...
CREATE  FUNCTION "value_count_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT /* &str */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "weighted_avg_agg"(
	"aggregate_name" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/access_method/triggers.rs:82
...
/* <begin connected objects> */
-- src/access_method/triggers.rs:30
...
/* <begin connected objects> */
-- src/highlighting/document_highlighter.rs:978
-- zombodb::highlighting::document_highlighter::highlight_proximity
CREATE  FUNCTION "highlight_proximity"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* &str */
	"text" TEXT, /* alloc::string::String */
...
CREATE  FUNCTION "date_histogram_agg"(
	"aggregate_name" TEXT, /* &str */
	"field" TEXT, /* &str */
...
CREATE  FUNCTION "zdbquery_from_text"(
	"input" TEXT /* &str */
...
/* <begin connected objects> */
-- src/zdbquery/mod.rs:869
-- zombodb::zdbquery::to_query_dsl
CREATE  FUNCTION "to_query_dsl"(
...
/* <begin connected objects> */
-- src/zdbquery/mod.rs:876
-- zombodb::zdbquery::to_queries_dsl
CREATE  FUNCTION "to_queries_dsl"(
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/ip_range.rs:9
-- zombodb::elasticsearch::aggregates::ip_range::ip_range
CREATE  FUNCTION "ip_range"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/percentiles.rs:8
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/terms.rs:363
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/query.rs:26
...
CREATE  FUNCTION "query_tids"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS tid[] /* alloc::vec::Vec<pgrx_pg_sys::include::pg14::ItemPointerData> */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "zdbquery_from_jsonb"(
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/date_histogram.rs:27
-- zombodb::elasticsearch::aggregates::date_histogram::date_histogram
CREATE  FUNCTION "date_histogram"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
	"calendar_interval" pg_catalog.CalendarInterval DEFAULT NULL, /* core::option::Option<zombodb::elasticsearch::aggregates::date_histogram::pg_catalog::CalendarInterval> */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/filters.rs:10
...
/* <begin connected objects> */
-- src/scoring/mod.rs:27
-- zombodb::scoring::want_scores
CREATE  FUNCTION "want_scores"(
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/range.rs:9
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/top_hits_with_id.rs:8
-- zombodb::elasticsearch::aggregates::top_hits_with_id::top_hits_with_id
CREATE  FUNCTION "top_hits_with_id"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"fields" TEXT[], /* alloc::vec::Vec<alloc::string::String> */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
CREATE  FUNCTION dsl."more_like_this"(
	...
	"stop_words" TEXT[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], /* alloc::vec::Vec<alloc::string::String> */
...
CREATE  FUNCTION "zdbquery_from_json"(
...
/* <begin connected objects> */
-- src/zdbquery/opclass.rs:11
-- zombodb::zdbquery::opclass::anyelement_cmpfunc
CREATE  FUNCTION "anyelement_cmpfunc"(
...
CREATE  FUNCTION "wrap_with_visibility_clause"(
	"index_relation" regclass, /* pgrx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
STRICT
...
CREATE  FUNCTION "zdbquery_to_jsonb"(
	"input" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS jsonb /* pgrx::datum::json::JsonB */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "want_highlight"(
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
-- requires:
--   highlighting::es_highlighting::highlight
CREATE  FUNCTION "highlight_all_fields"(
	"ctid" tid, /* pgrx_pg_sys::include::pg14::ItemPointerData */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/date_range.rs:9
-- zombodb::elasticsearch::aggregates::date_range::date_range
CREATE  FUNCTION "date_range"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/matrix_stats.rs:8
-- zombodb::elasticsearch::aggregates::matrix_stats::matrix_stats
CREATE  FUNCTION "matrix_stats"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"fields" TEXT[], /* alloc::vec::Vec<alloc::string::String> */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS TABLE (
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/significant_terms.rs:9
-- zombodb::elasticsearch::aggregates::significant_terms::significant_terms
CREATE  FUNCTION "significant_terms"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/significant_terms_two_level.rs:9
-- zombodb::elasticsearch::aggregates::significant_terms_two_level::significant_terms_two_level
CREATE  FUNCTION "significant_terms_two_level"(
	"index" regclass, /* pgrx::rel::PgRelation */
...
/* <begin connected objects> */
-- src/elasticsearch/suggest_term.rs:88
-- zombodb::elasticsearch::suggest_term::suggest_terms
CREATE  FUNCTION "suggest_terms"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_name" TEXT, /* alloc::string::String */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/extended_stats.rs:8
-- zombodb::elasticsearch::aggregates::extended_stats::extended_stats
CREATE  FUNCTION "extended_stats"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
CREATE  FUNCTION "query"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS SETOF tid /* pgrx_pg_sys::include::pg14::ItemPointerData */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/stats.rs:8
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/terms.rs:32
...
CREATE  FUNCTION "adjacency_matrix_agg"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"aggregate_name" TEXT, /* &str */
	"labels" TEXT[], /* pgrx::datum::array::Array<&str> */
	"filters" pg_catalog.ZDBQuery[] /* pgrx::datum::array::Array<zombodb::zdbquery::pg_catalog::ZDBQuery> */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/histogram.rs:8
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/percentile_ranks.rs:8
-- zombodb::elasticsearch::aggregates::percentile_ranks::percentile_ranks
CREATE  FUNCTION "percentile_ranks"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
CREATE  FUNCTION "top_hits"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"fields" TEXT[], /* alloc::vec::Vec<alloc::string::String> */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
	"size_limit" bigint /* i64 */
) RETURNS TABLE (
	"id" tid,  /* pgrx_pg_sys::include::pg14::ItemPointerData */
	"score" double precision,  /* f64 */
	"source" json  /* pgrx::datum::json::Json */
)
IMMUTABLE STRICT PARALLEL SAFE
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/significant_text.rs:9
-- zombodb::elasticsearch::aggregates::significant_text::significant_text
CREATE  FUNCTION "significant_text"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
-- zombodb::query_dsl::more_like_this::dsl::more_like_this
CREATE  FUNCTION dsl."more_like_this"(
	"like" TEXT[], /* alloc::vec::Vec<alloc::string::String> */
	"stop_words" TEXT[] DEFAULT ARRAY['http', 'span', 'class', 'flashtext', 'let', 'its', 'may', 'well', 'got', 'too', 'them', 'really', 'new', 'set', 'please', 'how', 'our', 'from', 'sent', 'subject', 'sincerely', 'thank', 'thanks', 'just', 'get', 'going', 'were', 'much', 'can', 'also', 'she', 'her', 'him', 'his', 'has', 'been', 'ok', 'still', 'okay', 'does', 'did', 'about', 'yes', 'you', 'your', 'when', 'know', 'have', 'who', 'what', 'where', 'sir', 'page', 'a', 'an', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'than', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with'], /* alloc::vec::Vec<alloc::string::String> */
	"fields" TEXT[] DEFAULT NULL, /* core::option::Option<alloc::vec::Vec<alloc::string::String>> */
	"boost" real DEFAULT NULL, /* core::option::Option<f32> */
	"unlike" TEXT DEFAULT NULL, /* core::option::Option<&str> */
...
/* <begin connected objects> */
-- src/zql/dsl/mod.rs:17
-- zombodb::zql::dsl::dump_query
CREATE  FUNCTION "dump_query"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS TEXT /* alloc::string::String */
IMMUTABLE STRICT PARALLEL SAFE
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/adjacency_matrix.rs:11
-- zombodb::elasticsearch::aggregates::adjacency_matrix::adjacency_matrix
CREATE  FUNCTION "adjacency_matrix"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"labels" TEXT[], /* pgrx::datum::array::Array<&str> */
	"filters" pg_catalog.ZDBQuery[] /* pgrx::datum::array::Array<zombodb::zdbquery::pg_catalog::ZDBQuery> */
) RETURNS TABLE (
...
CREATE  FUNCTION "zdbquery_to_json"(
	"input" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS json /* pgrx::datum::json::Json */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/query_dsl/geo.rs:89
-- zombodb::query_dsl::geo::dsl::geo_polygon
CREATE  FUNCTION dsl."geo_polygon"(
	"field" TEXT, /* &str */
	"points" VARIADIC point[] /* pgrx::datum::array::VariadicArray<pgrx_pg_sys::include::pg14::Point> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
/* <begin connected objects> */
-- src/elasticsearch/aggregates/terms_two_level.rs:27
-- zombodb::elasticsearch::aggregates::terms_two_level::terms_two_level
CREATE  FUNCTION "terms_two_level"(
	"index" regclass, /* pgrx::rel::PgRelation */
	"field_first" TEXT, /* &str */
	"field_second" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
...
/* <begin connected objects> */
-- src/query_dsl/datetime_range.rs:83
...
/* <begin connected objects> */
-- src/query_dsl/datetime_range.rs:62
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/query_dsl/datetime_range.rs:104
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/query_dsl/datetime_range.rs:125
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
/* <begin connected objects> */
-- src/query_dsl/datetime_range.rs:41
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC TEXT[] /* pgrx::datum::array::VariadicArray<alloc::string::String> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
