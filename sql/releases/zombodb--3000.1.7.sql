...
-- src/highlighting/query_highlighter.rs:447
...
-- src/highlighting/query_highlighter.rs:467
-- zombodb::highlighting::query_highlighter::highlight_document
CREATE  FUNCTION zdb."highlight_document"(
	"index" regclass, /* pgx::rel::PgRelation */
...
-- src/highlighting/document_highlighter.rs:738
...
-- src/highlighting/document_highlighter.rs:658
...
-- src/highlighting/document_highlighter.rs:778
...
-- src/highlighting/document_highlighter.rs:698
...
-- src/highlighting/document_highlighter.rs:818
...
-- src/access_method/triggers.rs:60
...
-- src/access_method/options.rs:493
...
-- src/access_method/options.rs:500
...
-- src/access_method/options.rs:517
...
-- src/access_method/options.rs:486
...
-- src/access_method/options.rs:546
...
-- src/access_method/options.rs:463
...
-- src/highlighting/document_highlighter.rs:863
...
CREATE  FUNCTION zdb."cardinality"(
	...
	"field" TEXT, /* &str */
	"query" pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
) RETURNS NUMERIC /* pgx::datum::numeric::AnyNumeric */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'cardinality_wrapper';

-- src/zql/dsl/mod.rs:19
...
CREATE  FUNCTION zdb."range"(
	...
	"from" NUMERIC,  /* core::option::Option<pgx::datum::numeric::AnyNumeric> */
	"to" NUMERIC,  /* core::option::Option<pgx::datum::numeric::AnyNumeric> */
	"doc_count" bigint  /* i64 */
)
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION zdb."stats"(
	...
	"count" bigint,  /* i64 */
	"min" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"max" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"avg" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"sum" NUMERIC  /* pgx::datum::numeric::AnyNumeric */
)
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION zdb."percentile_ranks"(
	...
	"value" NUMERIC  /* pgx::datum::numeric::AnyNumeric */
)
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION zdb."extended_stats"(
	...
	"avg" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"sum" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"sum_of_squares" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"variance" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"std_deviation" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"upper" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"lower" NUMERIC  /* pgx::datum::numeric::AnyNumeric */
)
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION zdb."histogram"(
	...
	"term" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"doc_count" bigint  /* i64 */
)
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION zdb."matrix_stats"(
	...
	"term" TEXT,  /* alloc::string::String */
	"count" bigint,  /* i64 */
	"mean" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"variance" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"skewness" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
	"kurtosis" NUMERIC,  /* pgx::datum::numeric::AnyNumeric */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC INT[] /* pgx::datum::array::VariadicArray<i32> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC TEXT[] /* pgx::datum::array::VariadicArray<&str> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC bigint[] /* pgx::datum::array::VariadicArray<i64> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC smallint[] /* pgx::datum::array::VariadicArray<i16> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC bool[] /* pgx::datum::array::VariadicArray<bool> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC double precision[] /* pgx::datum::array::VariadicArray<f64> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."terms"(
	"field" TEXT, /* &str */
	"values" VARIADIC real[] /* pgx::datum::array::VariadicArray<f32> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."span_or"(
	"clauses" VARIADIC pg_catalog.ZDBQuery[] /* pgx::datum::array::VariadicArray<zombodb::zdbquery::pg_catalog::ZDBQuery> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."sort_many"(
	"zdbquery" pg_catalog.ZDBQuery, /* zombodb::zdbquery::pg_catalog::ZDBQuery */
	"sort_descriptors" VARIADIC pg_catalog.SortDescriptor[] /* pgx::datum::array::VariadicArray<zombodb::zdbquery::pg_catalog::SortDescriptor> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."geo_polygon"(
	"field" TEXT, /* &str */
	"points" VARIADIC point[] /* pgx::datum::array::VariadicArray<pgx_pg_sys::pg14::Point> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
-- src/query_dsl/datetime_range.rs:124
...
-- src/query_dsl/datetime_range.rs:82
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
-- src/query_dsl/datetime_range.rs:61
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
-- src/query_dsl/datetime_range.rs:103
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
-- src/query_dsl/datetime_range.rs:40
-- zombodb::query_dsl::datetime_range::dsl::datetime_range
CREATE  FUNCTION dsl."datetime_range"(
	"field" TEXT, /* &str */
...
CREATE  FUNCTION dsl."not"(
	"queries" VARIADIC pg_catalog.ZDBQuery[] /* pgx::datum::array::VariadicArray<zombodb::zdbquery::pg_catalog::ZDBQuery> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION dsl."bool"(
	"parts" VARIADIC pg_catalog.BoolQueryPart[] /* pgx::datum::array::VariadicArray<zombodb::query_dsl::bool::pg_catalog::BoolQueryPart> */
) RETURNS pg_catalog.ZDBQuery /* zombodb::zdbquery::pg_catalog::ZDBQuery */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
-- src/elasticsearch/aggregates/terms.rs:377
