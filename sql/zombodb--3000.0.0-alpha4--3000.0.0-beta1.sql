...
DROP FUNCTION IF EXISTS version() CASCADE;
...
SELECT '3000.0.0-beta1 (e0ab27d1e8199a1f1f160c46ff8d9dbe7dda7956)'
$$;
...
DROP FUNCTION IF EXISTS dsl.match_all(boost pg_catalog.float4 DEFAULT '1.0') CASCADE;
...
DROP FUNCTION IF EXISTS dsl.terms_lookup(field text, index text, id text, path text, routing text DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.sd(field text, "order" sortdirection, mode sortmode DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.fuzzy(field text, value text, boost pg_catalog.float4 DEFAULT NULL, fuzziness pg_catalog.int4 DEFAULT NULL, prefix_length pg_catalog.int8 DEFAULT NULL, max_expansions pg_catalog.int8 DEFAULT '50', transpositions bool DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.span_not(include zdbquery, exclude zdbquery, pre_integer pg_catalog.int8 DEFAULT NULL, post_integer pg_catalog.int8 DEFAULT NULL, dis_integer pg_catalog.int8 DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.span_term(field text, value text, boost pg_catalog.float4 DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.wildcard(field text, value text, boost pg_catalog.float4 DEFAULT '1.0') CASCADE;
...
DROP FUNCTION IF EXISTS dsl.regexp(field text, regexp text, boost pg_catalog.float4 DEFAULT NULL, flags regexflags[] DEFAULT NULL, max_determinized_states pg_catalog.int4 DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.script(source text, params json DEFAULT NULL, lang text DEFAULT 'painless') CASCADE;
...
DROP FUNCTION IF EXISTS dsl.dis_max(queries zdbquery[], boost pg_catalog.float4 DEFAULT NULL, tie_breaker pg_catalog.float4 DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.match(field text, query text, boost pg_catalog.float4 DEFAULT NULL, analyzer text DEFAULT NULL, minimum_should_match pg_catalog.int4 DEFAULT NULL, lenient bool DEFAULT NULL, fuzziness pg_catalog.int4 DEFAULT NULL, fuzzy_rewrite text DEFAULT NULL, fuzzy_transpositions bool DEFAULT NULL, prefix_length pg_catalog.int4 DEFAULT NULL, cutoff_frequency pg_catalog.float4 DEFAULT NULL, auto_generate_synonyms_phrase_query bool DEFAULT NULL, zero_terms_query zerotermsquery DEFAULT NULL, operator operator DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.multi_match(fields text[], query text, boost pg_catalog.float4 DEFAULT NULL, analyzer text DEFAULT NULL, minimum_should_match pg_catalog.int4 DEFAULT NULL, lenient bool DEFAULT NULL, fuzziness pg_catalog.int4 DEFAULT NULL, fuzzy_rewrite text DEFAULT NULL, fuzzy_transpositions bool DEFAULT NULL, prefix_length pg_catalog.int4 DEFAULT NULL, cutoff_frequency pg_catalog.float4 DEFAULT NULL, auto_generate_synonyms_phrase_query bool DEFAULT NULL, zero_terms_query zerotermsquery DEFAULT NULL, operator operator DEFAULT NULL, match_type matchtype DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.match_phrase_prefix(field text, query text, boost pg_catalog.float4 DEFAULT NULL, slop pg_catalog.int4 DEFAULT NULL, analyzer text DEFAULT NULL, maxexpansion pg_catalog.int4 DEFAULT NULL, zero_terms_query zerotermsquery DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.nested(path text, query zdbquery, score_mode scoremode DEFAULT 'avg', ignore_unmapped bool DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS dsl.datetime_range(field text, lt date DEFAULT NULL, gt date DEFAULT NULL, lte date DEFAULT NULL, gte date DEFAULT NULL, boost pg_catalog.float4 DEFAULT NULL, relation relation DEFAULT 'intersects') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.terms(index regclass, field_name text, query zdbquery, size_limit pg_catalog.int4 DEFAULT '2147483647', order_by termsorderby DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS zdb.tally(index regclass, field_name text, stem text, query zdbquery, size_limit pg_catalog.int4 DEFAULT '2147483647', order_by termsorderby DEFAULT NULL, shard_size pg_catalog.int4 DEFAULT '2147483647', count_nulls bool DEFAULT 'true') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.significant_terms(index regclass, field text, query zdbquery, include text DEFAULT '.*', size_limit pg_catalog.int4 DEFAULT '2147483647', min_doc_count pg_catalog.int4 DEFAULT '3') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.histogram(index regclass, field text, query zdbquery, "interval" pg_catalog.float8, min_doc_count pg_catalog.int4 DEFAULT '0') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.significant_terms_two_level(index regclass, field_first text, field_second text, query zdbquery, size_limit pg_catalog.int4 DEFAULT '2147483647') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.extended_stats(index regclass, field text, query zdbquery, sigma pg_catalog.int8 DEFAULT '0') CASCADE;
...
DROP FUNCTION IF EXISTS zdb.analyze_custom(index regclass, field text DEFAULT NULL, text text DEFAULT NULL, tokenizer text DEFAULT NULL, normalizer text DEFAULT NULL, filter text[] DEFAULT NULL, char_filter text[] DEFAULT NULL) CASCADE;
...
DROP FUNCTION IF EXISTS zdb.want_highlight(query zdbquery, field text, highlight_definition json DEFAULT zdb.highlight()) CASCADE;
...
DROP FUNCTION IF EXISTS zdb.filter_agg(index regclass, aggregate_name text, filter zdbquery, children jsonb[] DEFAULT NULL) CASCADE;
