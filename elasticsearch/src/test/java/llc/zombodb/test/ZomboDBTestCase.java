...
//        LogConfigurator.configure(env);
    ...
    protected QueryRewriter qr(String query) {
        return new QueryRewriter(null, client(), DEFAULT_INDEX_NAME, node.injector().getInstance(NamedXContentRegistry.class), query, null, true, false, false) { /* anonymous implementation */ };
    }
