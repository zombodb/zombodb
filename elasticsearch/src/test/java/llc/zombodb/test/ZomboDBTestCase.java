...
//        LogConfigurator.configure(env);
    ...
    protected QueryRewriter qr(String query) {
        return new QueryRewriter(client(), DEFAULT_INDEX_NAME, node.injector().getInstance(NamedXContentRegistry.class), query, false, false, false) { /* anonymous implementation */ };
    }
