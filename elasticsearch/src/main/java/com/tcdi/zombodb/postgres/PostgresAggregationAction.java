...
public class PostgresAggregationAction extends BaseRestHandler {
    ...
    protected void handleRequest(RestRequest request, RestChannel channel, Client client) throws Exception {
        try {
            ...
            final QueryRewriter rewriter = QueryRewriter.Factory.create(client, request.paramAsLong("xid", 0), request.param("index"), request.param("preference"), input, true, true);
