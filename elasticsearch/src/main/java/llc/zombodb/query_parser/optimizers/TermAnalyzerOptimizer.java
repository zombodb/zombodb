...
public class TermAnalyzerOptimizer {
    ...
    private boolean analyzeNodes(QueryParserNode root) {
        ...
        if (root == null || root instanceof ASTOptions || root instanceof ASTSearchType || root instanceof ASTLimit || root instanceof ASTFieldLists || root instanceof ASTAggregate)
            return false;
