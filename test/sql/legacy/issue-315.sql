...
select json_array_element((zdb.dump_query('idxa', '#expand<b_group_id=<this.index>b_group_id>(pk_b_id = 100)')::json)->'subselect'->'query'->'subselect'->'query'->'subselect'->'query'->'bool'->'should', 0);
