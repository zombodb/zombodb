...
CREATE INDEX es_mam_test_reindex ON public.mam_test_reindex USING zombodb (zdb('mam_test_reindex', ctid), zdb_to_jsonb(mam_test_reindex.*)) WITH (url='http://localhost:9200/', replicas=1, shards=5);
