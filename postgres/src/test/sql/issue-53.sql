...
select * from mam_test_json where zdb('mam_test_json', ctid) ==> '#nonest((my_json.sub_state:"SC" AND my_json.sub_status:"I")
            AND (my_json.sub_state:"NC" AND my_json.sub_status:"A"))';
