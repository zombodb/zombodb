CREATE VIEW so_posts_view_without_score AS SELECT ctid, *, zdb(so_posts) zdb FROM so_posts;
CREATE VIEW so_posts_view_with_score AS SELECT ctid, zdb_score('so_posts', ctid), *, zdb(so_posts) zdb FROM so_posts;
