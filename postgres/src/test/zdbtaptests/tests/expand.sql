-- USAGE: $ pg_prove -d zombo_tests -U postgres tests/expand.sql
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( data_text_1 = "red" ) AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( data_text_1 = "red" ) AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( data_text_1 = "red" ) AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( var_text_1 = "yellow") AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( var_text_1 = "yellow") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand var, yellow');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 6, 8, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( var_text_1 = "yellow") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( (vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand data, snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 6, 8, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( (vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand var, snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 6, 8, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( (vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 3, 5, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand data, yellow & red');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[5, 9]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red") AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( var_text_1 = "yellow" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand data, yellow & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[5, 9]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( var_text_1 = "yellow" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand var, yellow & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 6, 8, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( var_text_1 = "yellow" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 3, 5, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( (data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand data, red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 3, 5, 6, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( (data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand var, red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 2, 3, 4, 5, 6, 8, 9, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( (data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[1, 3, 5, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand data, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[5, 9]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand var, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[2, 4, 5, 6, 10]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( var_text_1 = "yellow" AND data_text_1 = "red" AND vol_json.animal = "snakes") AND )) )';
...
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( data_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( data_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( data_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( var_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( var_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( var_text_1 = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT * FROM (SELECT 1 WHERE 1=2)x; --this returns an empty result set
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( vol_json.animal = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT * FROM (SELECT 1 WHERE 1=2)x; --this returns an empty result set
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( vol_json.animal = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT * FROM (SELECT 1 WHERE 1=2)x; --this returns an empty result set
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( vol_json.animal = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<data_bigint_expand_group=<this.index>data_bigint_expand_group>( ( vol_json = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<var_bigint_expand_group=<this.index>var_bigint_expand_group>( ( vol_json = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
DEALLOCATE ALL;
PREPARE expected_result AS SELECT unnest(ARRAY[7]::BIGINT[]);
PREPARE zdb_result AS SELECT pk_data FROM unit_tests.consolidated_record_view where zdb==>'( (#expand<vol_bigint_expand_group=<this.index>vol_bigint_expand_group>( ( vol_json = NULL) AND )) )';
SELECT set_eq('expected_result', 'zdb_result', 'expand vol, yellow & red & snakes');
--**********************************************************************************************************************
