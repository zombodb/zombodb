...
data_directory = '/var/ramfs/postgresql/9.3/main'		# use data in another directory
...
max_connections = 255			# (change requires restart)
...
#wal_sync_method = fsync		# the default is the first option
					...
					#   fsync_writethrough
					#   open_sync
full_page_writes = false			# recover from partial page writes
