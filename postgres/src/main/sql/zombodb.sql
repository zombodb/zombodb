...
CREATE VIEW zdb_index_stats AS
  ...
  SELECT
    ...
    (zdb_es_direct_request(indexrelid, 'GET', 'hints/_count')::json) -> 'count'             AS hints_count,
    (zdb_es_direct_request(indexrelid, 'GET', 'committed/_count')::json) -> 'count'         AS committed_count
  FROM stats;
